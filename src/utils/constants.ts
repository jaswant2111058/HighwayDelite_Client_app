...
export const TOAST_MESSAGES = {
  ...
  PASSWORD_NOT_MATCHING: "Password mismatch!",
  ...
  ADMIN_ADD_FAILED: "Admin add failed",
  ADMIN_PERMISSIONS_UPDATED: "Admin permissions updated successfully",
  ADMIN_PERMISSIONS_UPDATE_FAILED: "Admin permissions update failed",
  ADMIN_REMOVE_FAILED: "Admin remove failed",
